...
function ProductList({ onHomeClick }) {
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description: 'Useful herb with wellness benefits.',
          cost: '$9',
        },
      ],
    },
  ...
  const calculateTotalQuantity = () => (cartItems ? cartItems.reduce((total, item) => total + item.quantity, 0) : 0);
        ...
        <div className="ul">
          ...
          <div>
            <a href="#" onClick={handleCartClick}>
              <span style={{ color: "white", fontSize: "24px", marginRight: "8px" }}>Cart</span>
              <h1 className="cart">
            ...
            <div key={categoryGroup.category}>
              ...
              <div className="product-list">
                {categoryGroup.plants.map((plant) => {
                  const isAddedToCart = cartItems.some((item) => item.name === plant.name);
